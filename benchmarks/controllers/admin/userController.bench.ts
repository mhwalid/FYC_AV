...
Deno.bench(
  "La récupérations des utilisateurs ce passent correctement",
  async () => {
    const ctx = {
      request: {
...
Deno.bench(
  "La récupération d'un utilisateur ce passe correctement",
  async () => {
    const userId = "1";
    const ctx = {
      params: { userId },
...
Deno.bench(
  "La mise à jour de l'activité d'un utilisateur ce passe correctement",
  async () => {
    const ctx = {
      request: {
        hasBody: true,
